...
<div class="body"> 
  ...
  // หาก username และ password ตรงกัน จะมีข้อมูลในตัวแปร $row
    ...
    // เข้าสู่ระบบสำเร็จ
            echo '<h1 style="text-align: center; margin-top:20px; color: #009900" class="page-content page-content--centered">Login successful!</h1>';
  ...
  // กรณี username และ password ไม่ตรงกัน
    ...
    // ไม่สำเร็จ ชื่อหรือรหัสผ่านไม่ถูกต้อง";
            ...
            echo  'setTimeout( "window.location.href = history.back(1)", 5000)'; 
