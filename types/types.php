        ...
        <nav class="navUser">
            ...
            <div class="dropdown dropdown--quickSearch" id="quickSearch" aria-hidden="true" tabindex="-1" data-prevent-quick-search-close="">
                <div class="container">
                    ...
                    <form class="form" action="types.php">
    ...
    <div class="container">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">Types</span>
            </li>
        </ul>
        <h1 class="page-heading"><a href="types.php" class="breadcrumb-label">Types</a></h1> 
