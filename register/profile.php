  ...
  <div class="navPages-container" id="menu" data-menu="">
    <nav class="navPages">
      ...
      <ul class="navPages-list">
        ...
        <li class="navPages-item">
          <a class="navPages-action has-subMenu" href="../type/type.php" data-collapsible="navPages-18">
...
<div class="body">
    ...
    <main class="page">
      ...
      <div class="modal-body" style="background-color: lightgray;">
       ...
       <div class="writeReview-productDetails">
        ...
        <div class="left"><h2 style="padding: 5px; margin: 10px;"> Personal Information.</h2> <img src='a1.jpg' width="1000px"> 
  ...
  <div class="writeReview-productDetails">
                           <h2 style=" margin: 0px;"> Recent Orders </h2>

                           <?php
                           $stmt = $pdo->prepare(" SELECT allphoto.pname,allphoto.aname,items.pricePerpiece,items.quantity,orders.ord_date,orders.ord_id,orders.status
FROM allphoto,items,orders WHERE allphoto.aid = items.aid AND items.ord_id = orders.ord_id");
                           $stmt->execute();
                           while ($row = $stmt->fetch()) {?>
                            <div class="left1">
                            <p style="padding: 5px; margin: 10px;">
                                <img src="../photo/allphoto/<?=$row ["aname"]?>.jpg" width="200" style="float:left; padding: 10px;">
                                Name : <?=$row ["pname"] ?><br>
                                Product ID:  <?=$row ["aname"] ?><br>
                                price : $<?=$row ["pricePerpiece"] ?><br>
                                quantity : <?=$row ["quantity"] ?><br>
                                Datetime order: <?=$row ["ord_date"] ?><br>
                                Order ID : <?=$row["ord_id"] ?><br>
                                status : <?=$row ["status"] ?>
                                <br>
                                <br>
