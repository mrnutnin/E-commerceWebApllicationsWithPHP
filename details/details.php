...
<head>
    <title>Detail</title>
    <link rel='canonical' href='index.php'><meta property="og:type" content="product">
    <meta property="og:title" content="Ageze">
    <meta property="og:description" content="">
    <meta property="og:url" content="http://cornerstone-warm-demo.mybigcommerce.com/ageze/">
    <meta property="og:site_name" content="Cornerstone Demo">
    <meta property="og:image" content="http://cdn6.bigcommerce.com/s-efzfxrs/products/86/images/326/ageze1__43203.1454448999.500.750.jpg?c=2">
    ...
    <script type="text/javascript">
        var BCData = {"product_attributes":{"purchasable":true,"purchasing_message":null,"sku":null,"upc":null,"stock":null,"instock":true,"stock_message":null,"price":{"without_tax":{"formatted":"$18.00","value":18},"tax_label":"Tax"},"weight":null,"base":false,"image":null}};
    </script>
</head>
        ...
        <nav class="navUser">
            <ul class="navUser-section navUser-section--alt">
                ...
                <li class="navUser-item navUser-item--account">
                    <a class="navUser-action" href="../register/login/user-home.php"> <i class="fa fa-user" aria-hidden="true"></i>  <?=$_SESSION["username"]?> </a>
                </li>
                    ...
                    <li class="navPages-item">
                        ...
                        <div class="navPage-subMenu" id="navPages-18" aria-hidden="true" tabindex="-1">
                            <ul class="navPage-subMenu-list">
                                <li class="navPage-subMenu-item">php
...
<div class="body">
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb ">
                <a href="../all-photo/allphoto.php" class="breadcrumb-label">All Photo</a>
            </li>
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label"><?=$row["aname"]?></span>
            </li>
        </ul>
            ...
            <div class="productView">
                <section class="productView-details">
                    <div class="productView-product">
                        <h1 class="productView-title" itemprop="name">  <?=$row["pname"]?> </h1>
                        <div class="productView-price">
                            <div class="price-section price-section--withoutTax " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                <meta itemprop="price" content="18">
                                <meta itemprop="priceCurrency" content="CAD">
                                <span data-product-price-without-tax="" class="price price--withoutTax"> Price : $<?=$row["aprice"]?></span>
                            </div>
                        </div>
                        <span itemprop="name" >Product ID : <?=$row["aname"]?></span>
                    </div>
                </section>

                <section class="productView-images" data-image-gallery="">
                    <figure class="productView-image" data-image-gallery-main="" data-zoom-image='../photo/allphoto/<?=$row["aname"] ?>.jpg'>
                        <a href="http://cdn6.bigcommerce.com/s-efzfxrs/images/stencil/1280x1280/products/86/326/ageze1__43203.1454448999.jpg?c=2">
                            <img src='../photo/allphoto/<?=$row["aname"] ?>.jpg'>
                            <img class="../productView-image--default" src='photo/allphoto/<?=$row["aname"] ?>.jpg' data-main-image="">
                        </a>
                    </figure>
                </section>
                ...
                <section class="productView-details">
                    <div class="productView-options">
                        <form class="form" method="post" action="cart.php?action=add&aid=<?=$row["aid"]?>&pname=<?=$row["pname"]?>&aname=<?=$row["aname"]?>&aprice=<?=$row["aprice"]?>&adetail=<?=$row["adetail"]?>&qty=<?=$item["qty"]?>" enctype="multipart/form-data" data-cart-item-add="">
 ...
 <!--                    <div class="cart-item-info cart-item-quantity">
 ...
 -->
                ...
                <ul class="tabs" data-tab="" role="tablist">
                    <li class="tab is-active" role="presentational">
                        <a class="tab-title" href="#tab-similar" role="tab" tabindex="0" aria-selected="false" controls="tab-similar">New Photos</a>
                    </li>
                </ul>
                                            ...
                                            <div class="productCarousel-slide">
                                                <article class="card ">
                                                    <figure class="card-figure">
                                                        <a href="details.php?aid=<?=$row["aid"]?>">
                                                        ...
                                                        <figcaption class="card-figcaption">
                                                            <div class="card-figcaption-body">
                                                                <a href="details.php?aid=<?=$row["aid"]?>" class="button button--small card-figcaption-button" data-product-id="87">Details</a>
