...
<div class="body">
    <div class="container">
        <?php
        $stmt = $pdo->prepare("INSERT INTO email VALUES ('', ?)");
        $stmt->bindParam(1, $_POST["emailAddress"]);
        $stmt->execute(); 
        ...
        <main class="page">
            ...
            <h1 style="text-align: center; color: #009900" class="page-content page-content--centered"> Subscribed! </h1>
