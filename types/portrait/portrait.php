...
<head>
    <title>Types - Portrait - Photo Store </title>
        ...
        <nav class="navUser">
            ...
            <div class="dropdown dropdown--quickSearch" id="quickSearch" aria-hidden="true" tabindex="-1" data-prevent-quick-search-close="">
                <div class="container">
                    ...
                    <form class="form" action="portrait.php">
                ...
                <li class="navPages-item">
                    ...
                    <div class="navPage-subMenu" id="navPages-18" aria-hidden="true" tabindex="-1">
                        <ul class="navPage-subMenu-list">
                            ...
                            <li class="navPage-subMenu-item">
                                <a class="navPage-subMenu-action navPages-action" href="portrait.php">Portrait</a>
                            </li>
                            <li class="navPage-subMenu-item">
    ...
    <div class="container">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">Portrait</span>
            </li>
        </ul>
        <h1 class="page-heading"><a href="portrait.php" class="breadcrumb-label">Portrait</a></h1>
                ...
                <form action="/compare" method='POST' data-product-compare="">
                    <ul class="productGrid">
                        ...
                        $stmt->bindParam(4, $value); 
                                                ...
                                                <?php
                                                $stmt = $pdo->prepare("SELECT * FROM allphoto WHERE aname LIKE 'p%' ORDER BY RAND();");
                                                if (!empty($_GET)) 
                                                    $value = $_GET["search_query"];
                                                $stmt->bindParam(1, $value); 
                                                $stmt->execute(); 
