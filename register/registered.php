...
$stmt->bindParam(9, $_POST["District"]);
$stmt->bindParam(10, $_POST["Postcode"]);
$stmt->bindParam(11, $_POST["question"]);
$stmt->bindParam(12, $_POST["answer"]);
$stmt->execute(); 
                ...
                <div class="navPage-subMenu" id="navPages-18" aria-hidden="true" tabindex="-1">
                    <ul class="navPage-subMenu-list">
                        <li class="navPage-subMenu-item">
                            <a class="navPage-subMenu-action navPages-action" href="../types/types.html">All Types</a>
                        </li>
                        <li class="navPage-subMenu-item">
                            <a class="navPage-subMenu-action navPages-action" href="../types/portrait/portrait.html">Portrait</a>
                        </li>
                        <li class="navPage-subMenu-item">
                            <a class="navPage-subMenu-action navPages-action" href="../types/landscape/landscape.html">Landscape</a>
                        </li>
                        <li class="navPage-subMenu-item">
                            <a class="navPage-subMenu-action navPages-action" href="../types/dark/dark.html">Dark</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="navPages-item navPages-item-page">
               <a class="navPages-action" href="../about/about.html">About</a>
           </li>
           <li class="navPages-item navPages-item-page">
...
<div class="body">
    <div class="container">
        <main class="page">
            ...
            <h1 style="text-align: center; color: #009900" class="page-content page-content--centered"> Registed! </h1>
            <h3 style="text-align: center;" > Welcome to be our part everyone.</h3>
