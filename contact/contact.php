    ...
    <div class="container">
        ...
        <main class="page">
            ...
            <div class="page-content page-content--centered">
                <p><p style="text-align: center;">We're happy to answer questions or help you with returns.<br>Please fill out the form below if you need assistance.<br><br></p></p>

                <form data-contact-form="" class="form" action="submitContact.php" method="post">
                    <input type="hidden" name="page_id" id="page_id" value="4">
                    <div class="form-row form-row--half">
                        <div class="form-field">
                            <label class="form-label" for="contact_fullname">Full Name</label>
                            <input class="form-input" type="text" id="contact_fullname" name="Fname" value="" required="">
                        </div>

                        <div class="form-field">
                            <label class="form-label" for="contact_phone">Phone Number</label>
                            <input class="form-input" type="text" id="contact_phone" name="phone" value="" required="">
                        </div>

                        <div class="form-field">
                            <label class="form-label" for="contact_email">Email Address<small>Required</small>
                            </label>
                            <input class="form-input" type="text" id="contact_email" name="email" value="" required="">
                        </div>

                        <div class="form-field">
                            <label class="form-label" for="contact_orderno">Order Number</label>
                            <input class="form-input" type="text" id="contact_orderno" name="Onumber" >
                        </div>
                    </div>

                    <div class="form-field">
                        <label class="form-label" for="contact_question">Comments/Questions<small>Required</small></label>
                        <textarea name="comment" id="contact_question" rows="5" cols="50" class="form-input"></textarea>
                    </div>
