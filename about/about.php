    ...
    <header class="header" role="banner">
        ...
        <nav class="navUser">
            <ul class="navUser-section navUser-section--alt">
                ...
                <li class="navUser-item navUser-item--account">
                    <a class="navUser-action" href="../reister/editprofile.php?mid=<?=$_SESSION["mid"] ?>"> <i class="fa fa-wrench" aria-hidden="true"></i> Edit Profile </a>
                </li>
                <li class="navUser-item navUser-item--account">
        ...
        <div class="navPages-container" id="menu" data-menu="">
            <nav class="navPages">
                ...
                <li class="navPages-item navPages-item-page">
                 <a class="navPages-action" href="#">About</a>
                </li>
                <li class="navPages-item navPages-item-page">
...
<div class="body">
    <div class="container">
        ...
        <main class="page">
            <h1 class="page-heading">Author</h1>
                <div style="text-align: center">
                     <span><img class="__mce_add_custom__"  src="noom.jpg"  width="230" height="100" style="margin-bottom: 10px; margin-top:10px; "></span><br>
                     <span><strong>Name :</strong> Rueangyot Treemat <br> <strong>Student ID :</strong> 593020456-0 <br> <strong>Faculty :</strong> Science <br> <strong>Major :</strong> ComputerScience</span>
                </div>
                <div style="text-align: center">
                     <span><img class="__mce_add_custom__"  src="nut.jpg"  width="300" height="200" style="margin-bottom: 10px; margin-top:50px;"></span><br>
                     <span><strong>Name :</strong> Purinut Ninlaong <br> <strong>Student ID :</strong> 593020804-3 <br> <strong>Faculty :</strong> Science <br> <strong>Major :</strong> ComputerScience</span>
                </div>
                <div style="text-align: center">
                    <span><img class="__mce_add_custom__"  src="four.jpg"  width="250" height="100" style="margin-bottom: 10px; margin-top:50px;"></span><br>
                     <span><strong>Name :</strong> Jeerasak Krueaniam <br> <strong>Student ID :</strong> 593020410-4 <br> <strong>Faculty :</strong> Science <br> <strong>Major :</strong> ComputerScience</span>
                </div>
        </main>
    </div>
</div> 
