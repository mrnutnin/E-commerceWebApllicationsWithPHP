...
if ($_GET["action"]=="add") {
    ...
    if(array_key_exists($aid, $_SESSION['cart']))
        $_SESSION['cart'][$aid]['qty'] += $_POST['qty'];
 }
    // หากยังไม่เคยเลือกสินค้นนั้นจะ
    else
        $_SESSION['cart'][$aid] = $cart_item;

// ปรับปรุงจำนวนสินค้า
} else if ($_GET["action"]=="update") {
    $aid = $_GET["aid"];     
    $qty = $_GET["qty"];
    $_SESSION['cart'][$aid]['qty'] = $qty;

// ลบสินค้า
} else if ($_GET["action"]=="delete") {
    
    $aid = $_GET['aid'];
    unset($_SESSION['cart'][$aid]);
}
}
?>
<?php
...
<html class="no-js" lang="en">
    <head>
        ...
        <script>
            ...
            function update(aid) {
                var qty = document.getElementById(aid).value;
                // ส่งรหัสสินค้า และจำนวนไปปรับปรุงใน session
                document.location = "cart.php?action=update&aid=" + aid + "&qty=" + qty; 
            }
    </script>
...
<!-- 
    ...
    <script type="text/javascript">
        function beacon_deferred(beacon_api) { beacon_api.set_cookie_domain(".cornerstone-warm-demo.mybigcommerce.com");beacon_api.pageview('', 1720349, "product", {"product":{"product_code":"","name":"Ageze"},"customer":{"id":"anonymous"}}, 'b8717f11-9f9f-484b-aa8d-5378ea0cb942', 'a9810ee6-494c-4e03-8331-e0e111a93a62');}
    </script>
    <script type="text/javascript">
        (function(){var d=document,g=d.createElement('script'),s=d.getElementsByTagName('script')[0];g.type='text/javascript';g.defer=g.async=true;g.src='http://cdn5.bigcommerce.com/r-241f8bd274a850676bd9dcc9abbd8dacf8704e66/javascript/jirafe/beacon_api.js';s.parentNode.insertBefore(g,s);})();
    </script> -->
    <script type="text/javascript">
        (function (fn) {    var onloadFn = window.onload;    if (typeof onloadFn === "function") {        window.onload = function() {            onloadFn();            fn();        };    } else {        window.onload = fn;    }})(function() {    if (window.ga && window.ga.getByName("ampAnalyticsTracker")) {        document.getElementById("form-action-addToCart").addEventListener("click", function(event) {            window.ga("ampAnalyticsTracker.send", "event", "Product", "Add to Cart", "Standard");        });    }});
    </script>
    <script type="text/javascript">
        var BCData = {"product_attributes":{"purchasable":true,"purchasing_message":null,"sku":null,"upc":null,"stock":null,"instock":true,"stock_message":null,"aprice":{"without_tax":{"formatted":"$18.00","value":18},"tax_label":"Tax"},"weight":null,"base":false,"image":null}};
    </script>
...
<header class="header" role="banner">
        ...
        <nav class="navUser">
            ...
            <ul class="navUser-section navUser-section--alt">
                ...
                <li class="navUser-item navUser-item--cart">
                        ...
                        <span class="navUser-item-cartLabel">   <a href="cart.php" class="navUser-action" data-options="align:right"> <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart (<?php if(!isset($_SESSION['cart'])){echo "0";}else{echo sizeof($_SESSION['cart']);} ?>)    </a> </span>
    ...
    <main class="page-content" data-cart>
        ...
        <li class="breadcrumb ">
                <a href="../all-photo/allphoto.php" class="breadcrumb-label">Home</a>
        </li>
    ...
    Your Cart (<?php if(!isset($_SESSION['cart'])){echo "0";}else{echo sizeof($_SESSION['cart']);} ?>)   item) <br> <a href="../all-photo/allphoto.php">Go back to continue shopping</a>
</h1>
    ...
    <thead class="cart-header">
        <tr>
            ...
            <th class="cart-header-item">Edit/Delete</th>
        </tr>
    </thead>
...
?>
    ...
    <dl class="cart-item-options cart-item-options--giftWrapping">
        <dt class="cart-item-option-title">
          <p> Product ID: <?=$item["aname"]?></p>
                ...
                <td class="cart-item-block cart-item-info">
                    <span class="cart-item-label">Edit/Cencel</span>
                        <strong class="cart-item-value "> <a href="" onclick="update(<?=$item["aid"]?>)">Edit</a> /
                             <a href="?action=delete&aid=<?=$item["aid"]?>">Delete</a> </strong>
    ...
    <li class="cart-total">
        <div class="cart-total-label">
            <strong>Grand total ( Discount 50% ) :</strong>
        </div>
  ...
  <?php
                if(isset($_SESSION["username"])){?>
                 <div class="cart-actions">
                    <a class="button button--primary" href="checkout.php?mid=<?=$_SESSION["mid"] ?>" title="Click here to proceed to checkout">Check out</a>
                </div>

                <?php  }  else { ?>
                 <div class="cart-actions">
                    
 <a class="button button--primary" href="#" title="Click here to proceed to checkout" id="checkoutbf" onclick='alert("Please Login or Register before checkout!")'>Check out</a>
                </div>
	...
	<div>
		<form method="post" action="https://store-efzfxrs.mybigcommerce.com/checkout.php">
            ...
            <section class="footer-info">
                <article class="footer-info-col footer-info-col--small" data-section-type="footer-webPages">
                    ...
                    <ul class="footer-info-list">
                        ...
                        <?php
                        if(isset($_SESSION["username"])){?>
                        <li><a href='../register/profile.php?mid=<?=$_SESSION["mid"] ?>'> <?=$_SESSION["username"]?> </a></li>
                        ...
                        <fieldset class="form-fieldset">
                            ...
                            <div class="form-field">
                                ...
                                <div class="form-prefixPostfix wrap">
                                    ...
                                    <a href=""><input class="button button--primary form-prefixPostfix-button--postfix" type="submit" value="Subscribe"></a>
                                </div>
                            </div>
                        </fieldset>
                    </form>
