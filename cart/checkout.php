...
<?php
   ...
   $stmt = $pdo->prepare("SELECT * FROM allphoto WHERE aid = ?");
   $stmt->bindParam(1, $_GET["aid"]);  // 2. นำค่า aid ที่ส่งมากับ URL กำหนดเป็นเงื่อนไข        
        ...
        <nav class="navUser" >
            <ul class="navUser-section navUser-section--alt">
                ...
                < <li class="navUser-item navUser-item--cart">
                        ...
                        <span class="navUser-item-cartLabel">   <a href="checkout.php" class="navUser-action" data-options="align:right"> <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart (<?=sizeof($_SESSION['cart'])?>)   </a> </span>
                ...
                <li class="navUser-item navUser-item--account">
                    <a class="navUser-action" href="../register/profile.php?mid=<?=$_SESSION["mid"] ?>"> <i class="fa fa-user" aria-hidden="true"></i>  <?=$_SESSION["username"]?> </a>
                </li>
    ...
    <div class="container">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">My Checkout</span>
            </li>
        </ul>

        <main class="page">

            <h1 class="page-heading">My Checkout</h1>
            ...
            <div class="modal-body" style="background-color: lightgray;">
             ...
             <div class="writeReview-productDetails">
              <h2 style=" margin: 0px;"> Billing details </h2>
            ...
            <div class="left"><h2 style="padding: 5px; margin: 10px;">The shipping address</h2> <img src='a1.jpg' width="1000px"> 
                ...
                <p style="padding: 5px; margin: 10px;">
                 ...
                 Postcode : <?=$_SESSION["Postcode"] ?><br>
                  <a href="editprofile.php?mid=<?=$_SESSION["mid"] ?>" class="button button--small card-figcaption-button">Edit</a>
             </p>
     ...
     <form class="form writeReview-form" action="thanks.php" method="post">
                    <?php
            $stmt = $pdo->prepare("INSERT INTO orders VALUES ('', ?, ?, ? ,? ,?)");
            $stmt->bindParam(1, $_POST["ord_date"]);
            $stmt->bindParam(2, $_SESSION["Address"]);
            $stmt->bindParam(3, $_SESSION["Province"]);
            $stmt->bindParam(4, $_SESSION["District"]);
            $stmt->bindParam(5, $_SESSION["Postcode"]);

            $stmt->execute(); 
            $contactid = $pdo->lastInsertId();
            ?>
<div class="left1 " style="padding: 50px;">
    ...
    <tbody class="cart-list">
            ...
            <tr class="cart-item" data-item-row>
                <td class="cart-item-block cart-item-figure">
                        <img class="cart-item-image" src='../photo/allphoto/<?=$item["aname"]?>.jpg' title="images">
                </td>


                <td class="cart-item-block cart-item-title">
                       <h4 class="cart-item-name"><?=$item["pname"]?></h4>
                        <p class="cart-item-brand"> <?=$item["adetail"]?></p>
          ...
          <p> Product ID: <?=$item["aname"]?></p>
                ...
                <td class="cart-item-block cart-item-info">
                    <span class="cart-item-label">Price</span>
                        <span class="cart-item-value ">$<?=$item["aprice"]?></span>
                </td>
                ...
                <td class="cart-item-block cart-item-info cart-item-quantity">
                    ...
                    <div class="form-field form-field--increments">
                        ...
                        <div class="form-increment" data-quantity-change="">
                           <input type="number" id="<?=$item["aid"]?>" value="<?=$item["qty"]?>" min="1" max="100" onblur="update(<?=$item["aid"]?>)" >
...
<input type="submit" class="card-figcaption-button button button--primary" value="Purchase">
<a href="javascript:history.back()" style="text-decoration: none;"><input type="button" class="card-figcaption-button button button--primary" value="Back to edit you order"></a>
                ...
                <section class="footer-info">
                    <article class="footer-info-col footer-info-col--small" data-section-type="footer-webPages">
                        ...
                        <ul class="footer-info-list">
                            ...
                            <?php
                            if(isset($_SESSION["username"])){?>
                            <li><a href="../reister/profile.php"> <?=$_SESSION["username"]?> </a></li>
