...
<div class="heroCarousel-slide " style="background-image: url(photo/allphoto/p18.jpg)">
    <img class="heroCarousel-image" src="http://mrnutninlaong.ueuo.com/img/portfolio/fullsize/2.jpg" alt="" title="">
    <div class="heroCarousel-content">
        <h1 class="heroCarousel-title">Welcome to Xhamster!</h1>
        <p class="heroCarousel-description"></p>
        <a href="all-photo/allphoto.php"><span class="heroCarousel-action button button--primary button--large">Shop Now</span></a>
    </div>   
</div>
<div class="heroCarousel-slide " style="background-image: url(photo/allphoto/n4.jpg)">
    <img class="heroCarousel-image" src="http://mrnutninlaong.ueuo.com/img/portfolio/fullsize/8.jpg" alt="" title="">
    <div class="heroCarousel-content">
        <h1 class="heroCarousel-title">50% off when register today!</h1>
        <p class="heroCarousel-description"></p>
        <a href="all-photo/allphoto.php"><span class="heroCarousel-action button button--primary button--large">Shop Now</span></a>
    </div>   
</div>
<div class="heroCarousel-slide " style="background-image: url(photo/allphoto/n6.jpg)">
    <img class="heroCarousel-image" src="http://mrnutninlaong.ueuo.com/img/portfolio/fullsize/15.jpg" alt="" title="">
    <div class="heroCarousel-content">
        <h1 class="heroCarousel-title">Long time no see!</h1>
        <p class="heroCarousel-description"></p>
        <a href="all-photo/allphoto.php"><span class="heroCarousel-action button button--primary button--large">Shop Now</span></a>
    </div>
</div>
...
<div class="container">
    <div class="main full">
        <h2 class="page-heading">New Photos</h2>
...
<?php
$stmt = $pdo->prepare("SELECT * FROM allphoto WHERE aname LIKE 'n%' ORDER BY RAND();");
$stmt->execute();
?>
...
<script>window.__webpack_public_path__ = "https://cdn6.bigcommerce.com/s-efzfxrs/stencil/e9f6adc0-17ce-0135-3cf0-525400dfdca6/dist/";</script> 
<script src="theme.js"></script>

<!-- <script src="https://cdn6.bigcommerce.com/s-efzfxrs/stencil/e9f6adc0-17ce-0135-3cf0-525400dfdca6/dist/theme-bundle.main.js"></script> -->
...
<script>
        ...
        <script type="text/javascript" src="https://cdn5.bigcommerce.com/r-241f8bd274a850676bd9dcc9abbd8dacf8704e66/javascript/visitor_stencil.js?b112e"></script>
