...
<head>
    <title>Types - Dark - Photo Store </title>
    <!-- LoGO -->
        ...
        <nav class="navUser">
            ...
            <div class="dropdown dropdown--quickSearch" id="quickSearch" aria-hidden="true" tabindex="-1" data-prevent-quick-search-close="">
                <div class="container">
                    ...
                    <form class="form" action="dark.php">
                ...
                <li class="navPages-item">
                    ...
                    <div class="navPage-subMenu" id="navPages-18" aria-hidden="true" tabindex="-1">
                        <ul class="navPage-subMenu-list">
                            ...
                            <li class="navPage-subMenu-item">
                                <a class="navPage-subMenu-action navPages-action" href="../landscape/landscape.php">Landscape</a>
                            </li>
                            <li class="navPage-subMenu-item">
                                <a class="navPage-subMenu-action navPages-action" href="dark.php">Dark</a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <div class="container">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">Dark</span>
            </li>
        </ul>
        <h1 class="page-heading"><a href="dark.php" class="breadcrumb-label">Dark</a></h1>
                ...
                <form action="/compare" method='POST' data-product-compare="">
                  <ul class="productGrid">
                    ...
                    $stmt->bindParam(4, $value); 
                                                ...
                                                <?php
                                                $stmt = $pdo->prepare("SELECT * FROM allphoto WHERE aname LIKE 'd%' ORDER BY RAND();");
                                                if (!empty($_GET)) 
                                                    $value = $_GET["search_query"];
                                                $stmt->bindParam(1, $value); 
                                                $stmt->execute(); 
                            ...
                            <section class="footer-info">
                                <article class="footer-info-col footer-info-col--small" data-section-type="footer-webPages">
                                    ...
                                    <ul class="footer-info-list">
                                        ...
                                        <?php  }  else { ?>
                                        <li><a href="../../register/editprofile.php?mid=<?=$_SESSION["mid"] ?>"> Login </a></li>
                                        <?php } ?>
                                ...
                                <article class="footer-info-col footer-info-col--small" data-section-type="footer-categories">
                                    ...
                                    <ul class="footer-info-list">
                                        ...
                                        <li><a href="../../Landscape/Landscape.php">Landscape</a></li>
