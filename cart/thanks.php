        ...
        <ul class="navUser-section navUser-section--alt">
            ...
            <li class="navUser-item navUser-item--cart">
                <span class="navUser-item-cartLabel">   
                    <a href="../cart/cart.phpcart.php?action=add&aid=<?=$row["aid"]?>&pname=<?=$row["pname"]?>&aname=<?=$row["aname"]?>&aprice=<?=$row["aprice"]?>&adetail=<?=$row["adetail"]?>&qty=1" class="navUser-action" data-options="align:right"> 
...
<div class="body">
    <div class="container">
        <main class="page">
            ...
            <h1 style="text-align: center; color: #009900" class="page-content page-content--centered"> Thanks for order!</h1>
            <p style="text-align: center;" > Thank you for choosing us,We will contact you back as soon as possible. </p>
        ...
        <section class="footer-info">
            <article class="footer-info-col footer-info-col--small" data-section-type="footer-webPages">
                ...
                <ul class="footer-info-list">
                    ...
                    <?php
                    if(isset($_SESSION["username"])){?>
                    <li><a href="../register/proflie.php"> <?=$_SESSION["username"]?> </a></li>
