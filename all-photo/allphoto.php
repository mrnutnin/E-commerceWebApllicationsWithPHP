...
<body >
    ...
    <div class="header-logo header-logo--center" >
        <a href="..\index.php"><span class="header-logo-text">Photo Store</span></a>
    </div>
    <div class="navPages-container" id="menu" data-menu="">
        ...
        <ul class="navPages-list">
            <li class="navPages-item">
                <a class="navPages-action" href="allphoto.php">All Photo</a> 
                <li class="navPages-item">
    ...
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">All Photo</span>
            </li>
        </ul>
        <h1 class="page-heading"><a href="allphoto.php" class="breadcrumb-label">All Photo</a></h1>
                ...
                <form action="/compare" method='POST' >
                    <ul class="productGrid">
                        ...
                        $stmt->bindParam(4, $value); 
                                                ...
                                                <?php
                                                $stmt = $pdo->prepare("SELECT * FROM allphoto ORDER BY RAND();");
                                                if (!empty($_GET)) 
                                                    $value = $_GET["search_query"];
                                                $stmt->bindParam(1, $value); 
                                                $stmt->execute(); 
