...
<?php
$stmt = $pdo->prepare("SELECT * FROM users WHERE mid = ?");
...
<head>
    ...
    <link data-stencil-stylesheet="" href="style.css" rel="stylesheet">
    <script>
        var xmlHttp;

        function checkUser() {
            document.getElementById("username").className = "thinking form-input";
        ...
        function showUserStatus() {
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                if (xmlHttp.responseText == "okay") {
                    document.getElementById("username").className = "approved form-input";

                } else {
                    document.getElementById("username").className = "denied form-input";
    ...
    <script>
        ...
        function checkEmail() {
            document.getElementById("Email").className = "thinking form-input";
        ...
        function showEmailStatus() {
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                if (xmlHttp.responseText == "okay") {
                    document.getElementById("Email").className = "approved form-input";

                } else {
                    document.getElementById("Email").className = "denied form-input";
...
<body>
 ...
 <?php
        ...
        <li class="navUser-item navUser-item--account">
         <a class="navUser-action" href="login/logout.php"> <i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
       </li>

       <?php  }  else { ?>
       <li class="navUser-item navUser-item--account">
        <a class="navUser-action" href="login/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign in</a>
    ...
    <div class="navPages-container" id="menu" data-menu="">
        <nav class="navPages">
            ...
            <ul class="navPages-list">
                ...
                <li class="navPages-item">
                    <a class="navPages-action has-subMenu" href="types\index.php" data-collapsible="navPages-18">
                    ...
                    <div class="navPage-subMenu" id="navPages-18" aria-hidden="true" tabindex="-1">
                        <ul class="navPage-subMenu-list">
                            ...
                            <li class="navPage-subMenu-item">
                                <a class="navPage-subMenu-action navPages-action" href="../ypes/portrait/portrait.php">Portrait</a>
                            </li>
                            <li class="navPage-subMenu-item">
    ...
    <div class="container">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">My Account</span>
            </li>
        </ul>
        ...
        <main class="page">
            ...
            <div class="modal-body" style="background-color: lightgray;">
             ...
             <div class="writeReview-productDetails">
              <h2 style=" margin: 0px;"> Control Account </h2>


              <!--  box1l +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->

              <div class="left"><h2 style="padding: 5px; margin: 10px;"> Personal Information.</h2>

                <p style="padding: 5px; margin: 10px;">Hello <?=$_SESSION["username"]?>! <br>
                    ...
                    District : <?=$_SESSION["District"]?><br>
                    Postcode : <?=$_SESSION["Postcode"] ?><br>
                    question : <?=$_SESSION["question"] ?><br>
                    answer : <?=$_SESSION["answer"] ?><br>
                </p>
            ...
            <div class="left"><h2 style="padding: 5px; margin: 10px;">The shipping address</h2> <img src='a1.jpg' width="1000px"> 
     ...
     <form class="form writeReview-form" action="registered.php" method="post">
                    <fieldset class="form-fieldset">
                        <div class="form-field">
                            ...
                            <div class="form-field" id="" data-validation="">
                                <label class="form-label" for="_input">Username
                                 <small>Required</small>
                             </label>
                            
                          <input type="text" id="username" data-label="Name" name="username" class="form-input" aria-required="" required onblur="checkUser()" placeholder="4-15 characters Ex. aaa123Fo" pattern="[\w]{4,15}" title = "username incorrect " >
                         </div>
                         ...
                         <div class="form-field" id="" data-validation="">
                            ...
                            <input type="email" id="Email" data-label="Email" name="Email" class="form-input" aria-required="false" required onblur="checkEmail()" placeholder="Ex. abcd@abc.com">
                        </div>     
                        <!-- Password -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">Password
                                <small>Required</small>
                            </label>
                            <input type="password"  data-label="Password" name="password" class="form-input" aria-required="" required id="PS" pattern="[\w]{4,8}" placeholder="4-8 characters Ex.abc12df" title = "password incorrect" > 
                        </div>
                        <div class="form-field" id="" data-validation="" >
                            <label class="form-label" for="_input">Retype password
                                <small>Required</small>
                            </label>
                            <input type="password"  data-label="Password2" name="password2" class="form-input" aria-required="" required id="RE" onblur="checkpassword()" pattern="[\w]{4,8}" placeholder="4-8 characters Ex.abc12df"> <div><span id="show"> </span></div>
                        </div>
                        ...
                        <!-- FirstName -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">FirstName
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="FirstName" name="FirstName" class="form-input" aria-required="" required placeholder="Up to you">
                        </div>
                        <!-- LastName -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">LastName
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="LastName" name="LastName" class="form-input" aria-required="" required placeholder="Up to you"> 
                        </div>

                        <!-- Address -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">Address
                                <small>Required</small>
                            </label>
                            <textarea name="Address" id="_input" data-label="Address" rows="" aria-required="true" class="form-input" required></textarea>
                        </div>

                        <!-- Province -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">Province
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="Province" name="Province" class="form-input" aria-required="" required>
                        </div>

                        <!-- District -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">District
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="District" name="District" class="form-input" aria-required="true" required>
                        </div>

                        <!-- Postcode -->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">Postcode
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="Postcode" name="Postcode" class="form-input" aria-required="true" required pattern="[0-9]{3,6}" placeholder="3-6 number">
                        </div>

                        <!-- Phone Number-->
                        <div class="form-field" id="" data-validation="">
                            <label class="form-label" for="_input">Phone Number
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="Phone" name="phone" class="form-input" aria-required="true" required pattern="[0-9]{10,11}" placeholder="10-11 number">
                        </div>

                        <!-- Question-->
                        <div class="form-field"  data-validation="">
                            <label class="form-label" for="_input">Question
                                <small>Required</small>
                            </label>
                            <select name="question" id="question" required >
                                ...
                                <option value="3">Have you evey made sex?</option>
                                <option value="4">Have you evey made sex in the refrigerator?</option>
                        ...
                        <!-- Answer -->
                        <div class="form-field"  data-validation="">
                            <label class="form-label" for="_input">Answer
                                <small>Required</small>
                            </label>
                            <input type="text" id="_input" data-label="Answer" name="answer" class="form-input" aria-required="true" required>
                        </div>
                ...
                <section class="footer-info">
                    ...
                    <article class="footer-info-col footer-info-col--small" data-section-type="footer-categories">
                        ...
                        <ul class="footer-info-list">
                            ...
                            <li><a href="../types/portrait/portrait.html">Portrait</a></li>
                            <li><a href="../types/landscape/landscape.html">Landscape</a></li>
                            <li><a href="../types/dark/dark.html">Dark</a></li>
                        </ul>
                    </article>
