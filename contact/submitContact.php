...
<div class="body">
    <div class="container">
        <main class="page">
            <h1 style="text-align: center; color: #009900" class="page-content page-content--centered"> You have sent already! </h1>
            <h3 style="text-align: center;" > Thank you for your comment </h3>
            ...
            $stmt->bindParam(4, $_POST["Onumber"]);
...
<script>
        ...
        <script type='text/javascript'> setTimeout( "window.location.href = history.back(1)", 3000); </script>
