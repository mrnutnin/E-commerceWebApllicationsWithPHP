        ...
        function checkpassword() {
            ...
            var show = document.getElementById('show');
                if (PS == RE) {
                    ...
                    show.innerHTML = "Cerrect";
                    console.log(show);
                }

                else{
                    show.style.color = "red";
                    show.innerHTML = "Incorrect";
                    console.log(show);
                }
        ...
        <nav class="navUser">
           <ul class="navUser-section navUser-section--alt">
            ...
            <li class="navUser-item navUser-item--account">
                <a class="navUser-action" href="login/profile.php"> <i class="fa fa-user" aria-hidden="true"></i>  <?=$_SESSION["username"]?> </a>
            </li>
         ...
         <li class="navUser-item navUser-item--account">
            ...
            <span class="navUser-or">or</span> <a class="navUser-action" href="#"> <i class="fa fa-user-plus" aria-hidden="true"></i> Register</a>
        </li>
    ...
    <div class="container">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumb is-active">
                <span class="breadcrumb-label">New Account</span>
            </li>
        </ul>
        ...
        <section class="footer-info">
            <article class="footer-info-col footer-info-col--small" data-section-type="footer-webPages">
                ...
                <ul class="footer-info-list">
                    ...
                    <?php
                    if(isset($_SESSION["username"])){?>
                    <li><a href="profile.php"> <?=$_SESSION["fullname"]?> </a></li>
