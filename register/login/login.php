...
<head>
    ...
    <nav class="navUser">
       ...
       <ul class="navUser-section navUser-section--alt">
           ...
           <?php  }  else { ?>
                <li class="navUser-item navUser-item--account">
                <a class="navUser-action" href="#"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign in</a>
...
<ul class="breadcrumbs">
        ...
        <li class="breadcrumb is-active">
                <span class="breadcrumb-label">Sign</span>
        </li>
</ul>
...
<main class="page">
    ...
    <div class="login-row">
        <form class="login-form form" action="check-login.php" method="post">
            <div class="form-field">
                <label class="form-label" for="login_email" >Email Address:</label>
                <input class="form-input" name="Email" id="login_email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
            </div>
            <div class="form-field">
            ...
            <div class="form-actions">
                <a href='../../index.php'><input type="submit" class="button button--primary" value="Sign in"></a>
                <a class="forgot-password" href="forgetpass.php">Forgot your password?</a>
            </div>
        </form>
            <div class="new-customer">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="../registermember.php"><button class="button button--primary">Create Account</button></a>
                    </div>
                </div>
            </div>
    </div>
