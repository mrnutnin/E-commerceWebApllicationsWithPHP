    ...
    <header class="header" role="banner">
        ...
        <nav class="navUser">
           ...
           <ul class="navUser-section navUser-section--alt">
            ...
            <li class="navUser-item navUser-item--account">
               <a class="navUser-action" href="#"> <i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
           </li>
...
<div class="body">
    ...
    <div class="container">
        ...
        <h1 style="text-align: center;  margin-top:20px; " class="page-content page-content--centered"> Logout successful! </h1>
...
<script>
        ...
        <script type='text/javascript'>
           ...
           setTimeout( "window.location.href = history.back(1)", 3000); 
